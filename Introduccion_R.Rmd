...
R/ Ofrece el paquete predefinido de R.
...
```{R example}
pairList <- function(lista,multiplo)
{
...
a[2:6]
```
R1/ Devuelve posición

R2/ llamar posiciónes entre un rango especificamente

R3/Llamar elementos del vector en un rango definido uno a uno
